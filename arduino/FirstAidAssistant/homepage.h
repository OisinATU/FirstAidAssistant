...
<html lang="en">
  ...
  <body>
    ...
    <div class="card">
      ...
      <div id="stepName" class="subtext">--</div>
    </div>
      ...
      async function updateSensors() {
        try {
          ...
          document.getElementById("pulse").textContent =
            data.pulse >= 0 ? data.pulse + " bpm" : "No reading";

          document.getElementById("spo2").textContent =
            data.spo2 >= 0 ? data.spo2 + " %" : "No reading";
          ...
          document.getElementById("step").textContent = "ERR";
          document.getElementById("stepName").textContent = "ERR";
        }
      }
